...
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "naive"]), outfile="search_time_naive_naive.png")
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "marked"]), outfile="search_time_marked_marked.png")
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "watched"]), outfile="search_time_watched_watched.png")
