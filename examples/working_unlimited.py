...
REV = "de5f9c77c8ed0dee2231c874be5afc2a76f3c18e"
...
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "naive"], format="tex"), outfile="search_time_naive.tex")
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "marked"], format="tex"), outfile="search_time_marked.tex")
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "watched"], format="tex"), outfile="search_time_watched.tex")

exp.add_report(ScatterPlotReport(attributes=["sg_intitialization_time"], filter_algorithm=["default", "naive"]), format="tex", outfile="init_time_naive.tex")
exp.add_report(ScatterPlotReport(attributes=["sg_intitialization_time"], filter_algorithm=["default", "marked"], format="tex"), outfile="init_time_marked.tex")
exp.add_report(ScatterPlotReport(attributes=["sg_intitialization_time"], filter_algorithm=["default", "watched"], format="tex"), outfile="init_time_watched.tex")
