...
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "naive"], format="tex"), outfile="search_time_naive.png")
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "marked"], format="tex"), outfile="search_time_marked.png")
exp.add_report(ScatterPlotReport(attributes=["search_time"], filter_algorithm=["default", "watched"], format="tex"), outfile="search_time_watched.png")

exp.add_report(ScatterPlotReport(attributes=["sg_intitialization_time"], filter_algorithm=["default", "naive"]), format="tex", outfile="init_time_naive.png")
exp.add_report(ScatterPlotReport(attributes=["sg_intitialization_time"], filter_algorithm=["default", "marked"], format="tex"), outfile="init_time_marked.png")
exp.add_report(ScatterPlotReport(attributes=["sg_intitialization_time"], filter_algorithm=["default", "watched"], format="tex"), outfile="init_time_watched.png")
