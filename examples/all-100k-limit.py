...
exp.add_algorithm("default", REPO, REV, ["--search", "astar(blind(), sg = default, iteration_limit=10000)"])
exp.add_algorithm("naive", REPO, REV, ["--search", "astar(blind(), sg = naive, iteration_limit=10000)"])
exp.add_algorithm("marked", REPO, REV, ["--search", "astar(blind(), sg = marked, iteration_limit=10000)"])
exp.add_algorithm("timestamps", REPO, REV, ["--search", "astar(blind(), sg = timestamps, iteration_limit=10000)"])
exp.add_algorithm("psvn", REPO, REV, ["--search", "astar(blind(), sg = psvn, iteration_limit=10000)"])
