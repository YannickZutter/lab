...
exp.add_algorithm("timestamps", REPO, REV, ["--search", "astar(blind(), sg = timestamps, expansion_limit=100000)"])
...
exp.add_report(
    ScatterPlotReport(attributes=["tot_dur_gao"], filter_algorithm=["default", "timestamps"], scale="linear"),
